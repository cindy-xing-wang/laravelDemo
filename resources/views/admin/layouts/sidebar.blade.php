                ...
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <a href="{{route('staff.index')}}" class="menu-item">Staff List</a>
                            <a href="{{route('staff.create')}}" class="menu-item">New Staff</a>
                        </div>
                        <div class="nav-item active">
                            <a href="{{url('subsection1')}}"><i class="ik ik-edit"></i></i><span>Sub-section</span> </a>
                        </div>
                    </div>
                </nav>
            </div>
