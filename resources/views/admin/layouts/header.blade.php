                        ...
                        <div class="top-menu d-flex align-items-end">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="{{route('staff.index')}}" class="menu-item"> <i class="ik ik-menu"></i> Staff List</a>
                                    <a class="dropdown-item" href="{{route('staff.create')}}" class="menu-item"><i class="ik ik-edit"></i> New Staff</a>
